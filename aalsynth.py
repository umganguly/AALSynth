...
######################################################
if mypars.calcabscl: # Do just the first quasar
  ...
  if True:
    ...
    myquasar.readspec("WISEA J114047", "WISEA_J114047", redospline=False, vlo=mypars.vlo, vhi=mypars.vhi)
